...
btnConvert.addEventListener("click", () => {
    ...
    let expArr = inpExpression.split("").reverse();
    ...
    if (stack.length != 0){
        ...
        for (let j = 0; j < tmpStackLength; j++){
            ...
            prefixOutput.push(remainOpt);

        }

    }
    
    const finalResult = prefixOutput.reverse().join("");
